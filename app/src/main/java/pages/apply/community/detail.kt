...
open class GenPagesApplyCommunityDetail : BasePage {
    constructor(__ins: ComponentInternalInstance, __renderer: String?) : super(__ins, __renderer) {}
    companion object {
        @Suppress("UNUSED_PARAMETER", "UNUSED_VARIABLE")
        var setup: (__props: GenPagesApplyCommunityDetail) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenPagesApplyCommunityDetail
            ...
            val replyTo = reactive<ReplyTarget>(ReplyTarget(CommentId = 0 as Number, NickName = ""))
